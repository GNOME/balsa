...
static void libbalsa_mailbox_maildir_destroy(GtkObject * object);
...
GtkType libbalsa_mailbox_maildir_get_type(void)
{
	...
	static const GtkTypeInfo mailbox_info = {
	    ...
	    (GtkClassInitFunc) libbalsa_mailbox_maildir_class_init,
	    (GtkObjectInitFunc) libbalsa_mailbox_maildir_init,
	    /* reserved_1 */ NULL,
	    /* reserved_2 */ NULL,
...
libbalsa_mailbox_maildir_class_init(LibBalsaMailboxMaildirClass * klass)
{
    ...
    object_class->destroy = libbalsa_mailbox_maildir_destroy;
...
static void
libbalsa_mailbox_maildir_destroy(GtkObject * object)
{

...
static GtkObject *(* new_after) (BalsaDruidPage *prev, gchar *title) = balsa_druid_page_error_new_after;
...
#line 57 "balsa-druid-page-error.gob"
static void 
balsa_druid_page_error_init (BalsaDruidPageError *self)
#line 59 "balsa-druid-page-error.c"
{
 {
#line 57 "balsa-druid-page-error.gob"
...
#line 69 "balsa-druid-page-error.c"
 }
}


#line 32 "balsa-druid-page-error.gob"
GtkObject *
balsa_druid_page_error_new_after (BalsaDruidPage *prev, gchar *title)
{
...
#line 98 "balsa-druid-page-error.c"
	}
}

#line 49 "balsa-druid-page-error.gob"
void 
balsa_druid_page_error_goto_me (BalsaDruidPageError *self)
{
	...
	{
#line 50 "balsa-druid-page-error.gob"
...
#line 116 "balsa-druid-page-error.c"
	}
}


#line 64 "balsa-druid-page-error.gob"
static void 
...
{
	{
#line 65 "balsa-druid-page-error.gob"
		
		PARENT_HANDLER( self );
		gtk_widget_show_all( GTK_WIDGET( self ) );
	
#line 134 "balsa-druid-page-error.c"
	}
}
...
#line 158 "balsa-druid-page-error.c"
	}
}
#undef PARENT_HANDLER

#line 80 "balsa-druid-page-error.gob"
static gboolean 
		...
		(* GNOME_DRUID_PAGE_CLASS(parent_class)->back)(##args); }
{
	...
	{
#line 81 "balsa-druid-page-error.gob"
...
#line 184 "balsa-druid-page-error.c"
	}
}
#undef PARENT_HANDLER
#undef GET_NEW

 ...
 */
static GtkWidget *build_option_menu(option_list options[],
                                    gint num,
                                    GtkSignalFunc func)
{
...
static void build_left_side()
{
    ...
    fe_scroll = gtk_scrolled_window_new(NULL, NULL);
    gtk_scrolled_window_set_policy(GTK_SCROLLED_WINDOW(fe_scroll),
                                   GTK_POLICY_AUTOMATIC,
                                   GTK_POLICY_AUTOMATIC);
    gtk_widget_show(fe_scroll);

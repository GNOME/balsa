...
config_mailbox_add (LibBalsaMailbox * mailbox, const char *key_arg)
{
  ...
  if ( key_arg == NULL )
    ...
    tmp = g_strdup_printf(BALSA_CONFIG_PREFIX MAILBOX_SECTION_PREFIX "%s/", key_arg);
...
config_mailbox_init (const gchar * prefix)
{
  ...
  const gchar *key = prefix + strlen(BALSA_CONFIG_PREFIX MAILBOX_SECTION_PREFIX );
  GNode *node;
  gboolean is_mh;
...
config_global_load (void)
{
  ...
  balsa_app.date_string = gnome_config_get_string ("DateFormat=" DEFAULT_DATE_FORMAT);

  /* ... Headers to show */
  balsa_app.shown_headers    = d_get_gint ("ShownHeaders", HEADERS_SELECTED);

  g_free(balsa_app.selected_headers);
  balsa_app.selected_headers = gnome_config_get_string("SelectedHeaders=" DEFAULT_SELECTED_HDRS);
  g_strdown(balsa_app.selected_headers);

  /* ... Quote colouring */
  g_free (balsa_app.quote_regex);
  balsa_app.quote_regex = gnome_config_get_string("QuoteRegex=" DEFAULT_QUOTE_REGEX);
  ...
  balsa_app.message_font = gnome_config_get_string("MessageFont=" DEFAULT_MESSAGE_FONT);
  ...
  balsa_app.PrintCommand.PrintCommand = gnome_config_get_string("PrintCommand=a2ps -d -q %s");
  balsa_app.PrintCommand.linesize = d_get_gint ("PrintLinesize", DEFAULT_LINESIZE);
  balsa_app.PrintCommand.breakline = gnome_config_get_bool ("PrintBreakline=false");
  ...
  balsa_app.mblist_show_mb_content_info = gnome_config_get_bool ("ShowMailboxContentInfo=true");
  ...
  balsa_app.check_mail_upon_startup = gnome_config_get_bool ("OnStartup=false");
  ...
  balsa_app.charset = gnome_config_get_string("Charset=" DEFAULT_CHARSET);
  ...
  balsa_app.compose_headers = gnome_config_get_string ("ComposeHeaders=to subject cc");
  ...
  balsa_app.remember_open_mboxes =  gnome_config_get_bool ("RememberOpenMailboxes=false");
...
config_save (void)
{
  ...
  /* Section for the balsa_information() settings... */
  gnome_config_push_prefix(BALSA_CONFIG_PREFIX "InformationMessages/");
  gnome_config_set_int ("ShowInformationMessages", balsa_app.information_message );
  ...
  /* ... column width settings */
  gnome_config_set_int ("MailboxListNameWidth",   balsa_app.mblist_name_width);
  gnome_config_set_int ("MailboxListNewMsgWidth", balsa_app.mblist_newmsg_width);
  gnome_config_set_int ("MailboxListTotalMsgWidth",balsa_app.mblist_totalmsg_width);
  ...
  gnome_config_set_int ("IndexAttachmentWidth", balsa_app.index_attachment_width);
  gnome_config_set_int ("IndexFromWidth",    balsa_app.index_from_width);
  gnome_config_set_int ("IndexSubjectWidth", balsa_app.index_subject_width);
  ...
  gnome_config_set_string("PrintCommand", balsa_app.PrintCommand.PrintCommand);
  gnome_config_set_int ("PrintLinesize", balsa_app.PrintCommand.linesize);
  gnome_config_set_bool ("PrintBreakline", balsa_app.PrintCommand.breakline);
  ...
  gnome_config_set_bool ("ShowMailboxContentInfo", balsa_app.mblist_show_mb_content_info);
  ...
  gnome_config_set_vector("OpenMailboxes", g_list_length(balsa_app.open_mailbox_list), 
